...
public:
    ...
    explicit BenchmarkRunner(std::size_t measurements_capacity_bytes = 1ULL << 30,
        ...
        : measurements_{measurements_capacity_bytes},
          state_log_{state_log_capacity_bytes} {}
    ...
    [[nodiscard]] std::uint64_t records_collected() const noexcept {
        return measurements_.records_used();
    }
    [[nodiscard]] std::size_t state_log_bytes() const noexcept {
        return state_log_.bytes_used();
    }
