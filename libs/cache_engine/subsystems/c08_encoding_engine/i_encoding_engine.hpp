...
public:
    ...
    [[nodiscard]] virtual std::size_t encode(void const* input, std::size_t input_bytes, void* output,
                                             std::size_t output_capacity) noexcept = 0;

    [[nodiscard]] virtual std::size_t decode(void const* encoded, std::size_t encoded_bytes, void* output,
                                             std::size_t output_capacity) noexcept = 0;
