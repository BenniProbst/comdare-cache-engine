...
// Topic queuing (2 Achsen T17/T18, Doc 30 §8.0) — Durchreich-Defaults NoBuffer/LazyFlush (HOT = in-memory)
...
/// HotComposition — HOT als 15-Achsen-Permutations-Konfiguration.
///
...
struct HotComposition {
    using search_algo =
        traversal::axis_03a_search_algo::composable::ObservableHotPatriciaOrgan; // SEZIERT: crit-bit-Patricia
    ...
    COMDARE_DEFINE_COMPOSITION_LOCATION("::comdare::cache_engine::compositions::HotComposition",
