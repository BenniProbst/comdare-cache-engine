...
inline constexpr std::array<std::string_view, 18> kCompositionAxisNames = {
    ...
    "allocator",          "prefetch",        "concurrency",      "serialization",    "value_handle", "isa",
...
/// serialize_composition_path<P>() — der serialisierte Static-Pfad EINER 18-Achsen-Permutation (PermTuple<V0..V17>; INC-2c).
