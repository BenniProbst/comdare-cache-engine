...
[[nodiscard]] constexpr std::string_view lager_gattung_token(anatomy::AnatomyGattung g) noexcept {
    switch (g) {
        ...
        // benennt ("Wer eine Gattung hinzufuegt ... traegt sie HIER nach"). Der Token traegt
        // den Unterstrich, weil er GELESEN wird; der C++-Name bleibt HeuristikAdapter.
...
[[nodiscard]] constexpr std::string_view lager_genus_token(anatomy::AnatomyGenus g) noexcept {
    switch (g) {
        ...
        // HY-A1-NACHZUG, Ebene 2. Der Token heisst AUSGESCHRIEBEN und teilt bewusst kein
        // Segment mit "adapter" (dem Container-Genus eine Zeile darueber) -- auf der
        // Genus-Ebene waere die Verwechslung real, und zwei Genera unter demselben
