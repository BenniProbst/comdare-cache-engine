...
public:
    ...
    [[nodiscard]] static std::vector<AxisVariant> lookup(std::string_view axis_id) {
        ...
        if (axis_id == "1") {
            ...
            result.push_back(
                {"3.A", "BPlusBinarySearch", "libs/cache_engine/algorithm_profiles/sota/csb_tree.profile.xml"});
            ...
            result.push_back({"3.B", "OffsetBasedJump",
                              "prt_art/include/prt_art/default_lookup/prt_art_3b_cache_traversal_default.hpp"});
            ...
            result.push_back(
                {"7", "FractalChen", "libs/cache_engine/algorithm_profiles/sota/chen_fractal.profile.xml"});
            ...
            result.push_back(
                {"11", "LeafOnlySampledCounter", "cache_engine/concepts/telemetry/leaf_only_sampled_counter.hpp"});
            result.push_back(
                {"11", "RetroactiveAggregator", "cache_engine/concepts/telemetry/retroactive_aggregation.hpp"});
            ...
            result.push_back({"13.1", "ThreadPerCore",
                              "cache_engine/concepts/scheduling_strategy.hpp::WorkerPoolLayout::ThreadPerCore"});
            result.push_back({"13.1", "WorkStealing",
                              "cache_engine/concepts/scheduling_strategy.hpp::WorkerPoolLayout::WorkStealing"});
            result.push_back(
                {"13.1", "CpuPinning", "cache_engine/concepts/scheduling_strategy.hpp::WorkerPoolLayout::CpuPinning"});
