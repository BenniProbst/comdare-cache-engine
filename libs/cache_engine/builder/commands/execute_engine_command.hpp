...
public:
    ...
    [[nodiscard]] std::string_view command_name() const noexcept override { return "ExecuteEngineCommand"; }
    ...
    int execute() override {
        ...
        result_.throughput_ops_per_sec =
            (overall_ns > 0) ? (static_cast<double>(workload_.operation_count) * 1e9 / static_cast<double>(overall_ns))
                             : 0.0;
        ...
        result_.memory_footprint_bytes = engine_callable_ ? bytes_touched_total : workload_.record_count * 64;
    ...
    [[nodiscard]] const ExecutionResult& result() const noexcept { return result_; }
