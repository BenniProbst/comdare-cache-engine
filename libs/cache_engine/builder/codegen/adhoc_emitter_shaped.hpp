...
render_adhoc_module_source_shaped(int idx, std::string_view shape_fq, std::string_view shape_include,
                                  std::string_view macro_args, std::string_view organ_stamp = {},
                                  std::string_view system_stamp = {}, std::string_view measurement_stamp = {}) {
    std::string src = "// AUTO-GENERATED by 234-V-a adhoc_emitter (SHAPED) -- Permutation " + std::to_string(idx) +
                      " -- DO NOT EDIT\n"
    ...
    // KON47-01/Option a, shaped-Sibling-Nachzug (Zweitlens-Befund 12.08.): dieselbe Stempel-Weiche wie
    // render_adhoc_module_source (dort ausfuehrlich begruendet, adhoc_emitter.hpp) -- ohne sie traefe
