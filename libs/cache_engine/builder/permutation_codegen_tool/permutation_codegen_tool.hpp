...
//
// Portierungs-Umfang (Ausgang lt. Aufgabenstellung: die `permutations.cmake`):
...
// Die per-Permutation Wrapper-.cpp + perm_versions/*.version (codegen.cmake Zeile 179-514, V36.E
// selective-rebuild) sind NICHT Teil dieses Tools — siehe Kopf von permutation_codegen_tool.cpp.
...
struct Inputs {
    ...
    std::string           mode       = "on_build_on_demand"; ///< COMDARE_MODE (nur Header-Kommentar)
