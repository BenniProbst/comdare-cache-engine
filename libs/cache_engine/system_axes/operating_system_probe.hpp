// system_axes/operating_system_probe.hpp -- prozess-freie RT-Erhebung der OS-Unter-Achsen (OS-U3).
//
...
// mit dem uebrigen Bestand auf "1.0.0.c" gezogen (deklariertes probe_id-Byte-Ereignis), und die gated
...
inline constexpr std::string_view kOsProbeVersion  = "1.0.0.c";
...
#include <system_axes/operating_system_probe_linux.hpp>
#include <system_axes/operating_system_probe_macos.hpp>
#include <system_axes/operating_system_probe_windows.hpp>
