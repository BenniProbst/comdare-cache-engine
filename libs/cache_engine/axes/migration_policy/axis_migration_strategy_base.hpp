...
class MigrationStrategyBase : public ::comdare::cache_engine::topics::OrganAxis<Derived> {
public:
    ...
    /// Boden + n/a: die Achse ist decide-only, ein realer Tier-Umzug findet nicht statt (Katalog T13 'decide-only') -- tier_moves ist ehrlich n/a.
