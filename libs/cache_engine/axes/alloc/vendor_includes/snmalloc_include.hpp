...
inline void*       aligned_alloc(std::size_t /*alignment*/, std::size_t /*size*/) noexcept { return nullptr; }
inline void        free_aligned_sized(void* /*p*/, std::size_t /*alignment*/, std::size_t /*size*/) noexcept {}
