#pragma once
// V41.F.6.1 axis_q1_buffer_strategy Registry (W6-Pattern, 2026-05-26)
//
...
#include "axis_q1_buffer_strategy_no_buffer.hpp"
#include "axis_q1_buffer_strategy_fifo.hpp"
#include "axis_q1_buffer_strategy_lifo.hpp"
#include "axis_q1_buffer_strategy_bounded_ring.hpp"
...
static_assert(mp::mp_size<EnabledStrategies>::value > 0,
    "axis_q1_buffer_strategy: at least one strategy must be enabled");
