#pragma once
// V41.F.6.1.R7.5.j axis_09b Sve2Extension (Aarch64 ARMv9, Grace Hopper)
...
/// Sve2Extension — ARM SVE2 (Scalable Vector Extension 2, ARMv9 Mandatory).
...
class Sve2Extension : public SimdExtensionStrategyBase<Sve2Extension> {
public:
    ...
    [[nodiscard]] static constexpr std::string_view family_name()           noexcept { return "Sve2Extension (ARM SVE2 scalable 128-2048bit, ARMv9, ZIH Grace Hopper)"; }
...
namespace comdare::cache_engine::hardware::axis_09b_simd_extension {
    static_assert(concepts::SimdExtensionStrategy<Sve2Extension>);
    static_assert(concepts::CacheEnginePermutationStrategy<Sve2Extension>);
}
