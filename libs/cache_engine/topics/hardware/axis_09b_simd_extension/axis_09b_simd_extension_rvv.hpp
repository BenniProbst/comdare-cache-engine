#pragma once
// V41.F.6.1.R7.5.j axis_09b RvvSimdExtension (RISC-V Vector Extension, scalable)
...
/// RvvSimdExtension — RISC-V Vector Extension (RVV v1.0 ratifiziert 2021).
...
class RvvSimdExtension : public SimdExtensionStrategyBase<RvvSimdExtension> {
public:
