#pragma once
// V41.F.6.1.R7.5.j axis_09b CudaGh200Extension (NVIDIA Grace Hopper GPU-Beschleuniger)
...
/// CudaGh200Extension — NVIDIA CUDA auf Hopper GH200 (Grace Hopper Superchip).
...
class CudaGh200Extension : public SimdExtensionStrategyBase<CudaGh200Extension> {
public:
    ...
    [[nodiscard]] static constexpr std::string_view family_name()           noexcept { return "CudaGh200Extension (NVIDIA Hopper GH200, NVLink-C2C 900GB/s, ZIH Grace Hopper)"; }
...
namespace comdare::cache_engine::hardware::axis_09b_simd_extension {
    static_assert(concepts::SimdExtensionStrategy<CudaGh200Extension>);
    static_assert(concepts::CacheEnginePermutationStrategy<CudaGh200Extension>);
}
