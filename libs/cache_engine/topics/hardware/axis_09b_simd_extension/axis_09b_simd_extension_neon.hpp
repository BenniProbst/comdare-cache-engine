#pragma once
// V41.F.6.1.R7.5.j axis_09b NeonSimdExtension (Aarch64 ABI-baseline, 128-bit)
...
/// NeonSimdExtension — ARM NEON AdvSIMD 128-bit (Aarch64 ABI-baseline ARMv8+).
/// Auf jeder AArch64-CPU vorhanden: Apple M-Series, AWS Graviton 2/3/4,
/// NVIDIA Grace, Ampere Altra.
class NeonSimdExtension : public SimdExtensionStrategyBase<NeonSimdExtension> {
public:
