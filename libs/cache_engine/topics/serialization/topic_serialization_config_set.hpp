...
template <class S> using make_observable_serialization = ::comdare::cache_engine::serialization_axis::ObservableSerialization<S>;

struct TopicConfigSet {
    using StaticAxisVariants_10 = mp::mp_transform<make_observable_serialization, axis_10_serialization::EnabledSerializers>;
