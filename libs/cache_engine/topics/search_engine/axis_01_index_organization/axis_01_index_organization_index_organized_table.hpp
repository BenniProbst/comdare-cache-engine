#pragma once
// V41.F.6.1.R7.5.h axis_01 IndexOrganizedTable (IOT, Daten in Leaf-Pages)
...
/// IndexOrganizedTable — Daten direkt in Index-Leaf-Pages eingebettet (Oracle IOT).
...
class IndexOrganizedTable : public IndexOrganizationStrategyBase<IndexOrganizedTable> {
public:
    ...
    [[nodiscard]] static constexpr std::string_view family_name()           noexcept { return "IndexOrganizedTable (Oracle IOT, Daten in B+Tree-Leaves, ART/HOT-style)"; }
...
namespace comdare::cache_engine::search_engine::axis_01_index_organization {
    static_assert(concepts::IndexOrganizationStrategy<IndexOrganizedTable>);
    static_assert(concepts::CacheEnginePermutationStrategy<IndexOrganizedTable>);
}
