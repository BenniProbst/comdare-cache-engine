#pragma once
// V41.F.6.1.R7.5.d axis_14 VersionedPointerHandle (MVCC)
...
/// VersionedPointerHandle — Pointer mit Version-Tag (MVCC).
...
class VersionedPointerHandle : public ValueHandleStrategyBase<VersionedPointerHandle> {
public:
    ...
    [[nodiscard]] static constexpr std::string_view family_name()  noexcept { return "VersionedPointerHandle (MVCC version-tagged pointer, Masstree/SMART)"; }
...
namespace comdare::cache_engine::value_handle::axis_14_value_handle {
    static_assert(concepts::ValueHandleStrategy<VersionedPointerHandle>);
    static_assert(concepts::CacheEnginePermutationStrategy<VersionedPointerHandle>);
}
