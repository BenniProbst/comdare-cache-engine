...
// RawSlotStore (composable_search.hpp:34-50) zu einem EXPLIZITEN Vertrag ueber GEMEINSAMEM
// breitem Key (uint64). Es wird KEINE neue Abstraktion erfunden — der Vertrag wird aus der
...
/// STORAGE-Organ-Concept: index-basiertes Slot-Substrat ueber GEMEINSAMEM breitem Key (uint64).
