#pragma once
// V41.F.6.1.R7.1.d axis_04 Node48Type (ART large node, indirect-array)
...
public:
    ...
    [[nodiscard]] static constexpr std::string_view family_name()  noexcept { return "Node48Type (ART large, indirect-array 48-slot)"; }
...
namespace comdare::cache_engine::nodes::axis_04_node_type {
    static_assert(concepts::NodeTypeStrategy<Node48Type>);
    static_assert(concepts::CacheEnginePermutationStrategy<Node48Type>);
}
