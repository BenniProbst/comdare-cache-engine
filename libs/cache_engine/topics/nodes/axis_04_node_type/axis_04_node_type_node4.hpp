#pragma once
// V41.F.6.1.R7.1.d axis_04 Node4Type (ART small node, 4 slots)
...
/// Node4Type — ART small node mit 4 Slots (Leis ICDE 2013).
/// Linear-Search optimal fuer kleine Node-Fanouts (Cache-Line passend).
class Node4Type : public NodeTypeStrategyBase<Node4Type> {
public:
    ...
    [[nodiscard]] static constexpr std::string_view family_name()  noexcept { return "Node4Type (ART small node, 4-slot linear-search)"; }
...
namespace comdare::cache_engine::nodes::axis_04_node_type {
    static_assert(concepts::NodeTypeStrategy<Node4Type>);
    static_assert(concepts::CacheEnginePermutationStrategy<Node4Type>);
}
