#pragma once
// DOSSIER W1/234-K axis_bst_shape CacheEngine-Permutation-Concept

#include "axis_bst_shape_concept.hpp"
#include <concepts>
#include <string_view>
...
template <typename S>
concept CacheEnginePermutationStrategy = BstShape<S> && requires {
    typename S::axis_tag;
