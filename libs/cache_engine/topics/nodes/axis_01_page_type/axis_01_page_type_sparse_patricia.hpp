...
public:
    ...
    [[nodiscard]] static constexpr concepts::PageKind page_kind() noexcept {
        return concepts::PageKind::SparsePatricia;
    }
    ...
    [[nodiscard]] static constexpr std::string_view family_name() noexcept {
        return "SparsePatriciaPageType (sparse Patricia-compressed page)";
    }
