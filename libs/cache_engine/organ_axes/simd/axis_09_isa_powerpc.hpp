...
#include <organ_axes/simd/axis_09_isa_flags.hpp>
...
public:
    ...
    COMDARE_DEFINE_ORGAN_LOCATION("::comdare::cache_engine::simd::PowerPcIsa", "organ_axes/simd/axis_09_isa_powerpc.hpp");
