...
public:
    ...
    // Traversal-Organ KAryTraversal<Arity> (organ_axes/lookup/composable/k_ary_traversal_organ.hpp) ist compile-time +
...
public:
    ...
    COMDARE_DEFINE_ORGAN_LOCATION("::comdare::cache_engine::lookup::KArySearchAlgo",
                                  "organ_axes/lookup/axis_03a_search_algo_k_ary.hpp");
