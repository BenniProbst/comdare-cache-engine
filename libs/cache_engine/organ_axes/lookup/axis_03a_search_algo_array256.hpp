...
/// DIE SUBSTANZ des S01-Organs (ART Node256 direkt-adressiert) -- HEAP-FREI (Form A).
///
...
class Array256SearchAlgoCore : public SearchAlgoBase<Self> {
public:
    ...
    Array256SearchAlgoCore() noexcept : count_(0) {}

    [[nodiscard]] bool operator==(Array256SearchAlgoCore const& other) const noexcept { return count_ == other.count_; }
...
/// DIE IDENTITAET -- das Registry-Organ S01. Nicht-Template, exakt der historische Typ-Name.
class Array256SearchAlgo final
    : public detail::Array256SearchAlgoCore<::comdare::cache_engine::alloc::ExgenAllocator, Array256SearchAlgo> {
public:
    ...
    COMDARE_DEFINE_ORGAN_LOCATION("::comdare::cache_engine::lookup::Array256SearchAlgo",
                                  "organ_axes/lookup/axis_03a_search_algo_array256.hpp");

    /// Der Migrations-Ausweis (composable::AllocatorRebindableSearchAlgo).
    template <class A2>
    using rebind_allocator = Array256SearchAlgoRebound<A2>;

    using detail::Array256SearchAlgoCore<default_allocator_type, Array256SearchAlgo>::Array256SearchAlgoCore;
};

/// DIE GEBUNDENE FORM -- traegt BEWUSST KEIN COMDARE_DEFINE_ORGAN_LOCATION.
template <class A2>
class Array256SearchAlgoRebound final : public detail::Array256SearchAlgoCore<A2, Array256SearchAlgoRebound<A2>> {
public:
    /// Der EBENEN-AUSWEIS (s. composable::IsReboundSearchAlgoLeaf).
    using axis03a_rebound_tag = void;

    using detail::Array256SearchAlgoCore<A2, Array256SearchAlgoRebound<A2>>::Array256SearchAlgoCore;
};
...
// ---------------------------------------------------------------------------------------------
static_assert(std::is_same_v<composable::search_algo_for_composition_t<Array256SearchAlgo,
...
static_assert(
    composable::AllocatorRebindableSearchAlgo<Array256SearchAlgo, ::comdare::cache_engine::alloc::ExgenAllocator>,
    "01c: Array256SearchAlgo traegt keinen rebind_allocator mehr -- nicht migriert.");
static_assert(!composable::IsReboundSearchAlgoLeaf<Array256SearchAlgo>,
...
static_assert(
    composable::IsReboundSearchAlgoLeaf<Array256SearchAlgoRebound<::comdare::cache_engine::alloc::ExgenAllocator>>,
    "01c: der Rebound-Leaf traegt seinen Ausweis nicht -- der Identitaets-Pin kann nicht mehr greifen.");
static_assert(composable::search_algo_name_is_allocator_invariant_v<Array256SearchAlgo,
                                                                    ::comdare::cache_engine::alloc::ExgenAllocator>,
              "01c name()-INVARIANZ (Level 0) verletzt.");
static_assert(Array256SearchAlgo::name() ==
                  Array256SearchAlgoRebound<::comdare::cache_engine::alloc::ExgenAllocator>::name(),
...
static_assert(std::is_trivially_destructible_v<Array256SearchAlgo> && std::is_trivially_copyable_v<Array256SearchAlgo>,
...
static_assert(
    std::is_trivially_destructible_v<Array256SearchAlgoRebound<::comdare::cache_engine::alloc::ExgenAllocator>> &&
        std::is_trivially_copyable_v<Array256SearchAlgoRebound<::comdare::cache_engine::alloc::ExgenAllocator>>,
    "01c MINIMAL-FORM VERLETZT: der Rebound-Leaf ist nicht mehr heap-frei.");
#endif
static_assert(sizeof(Array256SearchAlgo) ==
                  sizeof(Array256SearchAlgoRebound<::comdare::cache_engine::alloc::ExgenAllocator>),
...
static_assert(concepts::SearchAlgoVariant<Array256SearchAlgoRebound<::comdare::cache_engine::alloc::ExgenAllocator>>);
static_assert(concepts::CacheEngineSearchAlgoPermutationStrategy<
              Array256SearchAlgoRebound<::comdare::cache_engine::alloc::ExgenAllocator>>);
static_assert(
    concepts::DensityClassifiedStrategy<Array256SearchAlgoRebound<::comdare::cache_engine::alloc::ExgenAllocator>>);
} // namespace comdare::cache_engine::lookup
