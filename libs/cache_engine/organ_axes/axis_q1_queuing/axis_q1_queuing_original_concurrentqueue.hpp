...
#include <organ_axes/axis_q1_queuing/legacy_code/paper_q01_concurrentqueue_is_original.hpp>
#endif
...
public:
    ...
    [[nodiscard]] static constexpr std::string_view name() noexcept {
        if constexpr (enabled) {
            return "original_concurrentqueue";
        } else {
    ...
    COMDARE_DEFINE_ORGAN_LOCATION(
        ...
        "organ_axes/axis_q1_queuing/axis_q1_queuing_original_concurrentqueue.hpp");
...
static_assert(
    OriginalLockFreeMpmcConcurrentQueue::is_original_get(),
