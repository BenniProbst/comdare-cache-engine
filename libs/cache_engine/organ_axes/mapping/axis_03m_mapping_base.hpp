...
#include <organ_axes/alloc/axis_06_allocator_exgen.hpp> // A8-S5-03: Versorger-Achse der Slot-Tabellen (s.u.)
...
/// organ_axes/alloc/ zieht keinen 03m-Header -> kein Zyklus.
///
