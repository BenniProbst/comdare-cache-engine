...
// persistence_target-Strategie. Vorbild 1:1 organ_axes/io_dispatch/axis_io_dispatch_observable.hpp.
//
...
public:
    ...
    // verifiziert am 26.07. mit c++ -std=c++23. organ_axes/io_dispatch/axis_io_dispatch_observable.hpp reicht sie
