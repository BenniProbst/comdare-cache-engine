...
//
// Durchreich-Koerper 1:1 nach organ_axes/migration_policy/axis_migration_none.hpp (NoMigration): family_id 0,
...
public:
    ...
    COMDARE_DEFINE_ORGAN_LOCATION("::comdare::cache_engine::persistence_target::MemoryOnlyTarget",
                                  "organ_axes/persistence_target/axis_persistence_target_memory_only.hpp");
