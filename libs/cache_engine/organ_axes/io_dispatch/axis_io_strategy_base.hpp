...
public:
    ...
    /// Boden + n/a: die Achse ist eine In-Memory-Dispatch-SIMULATION, Geraete-Groessen (device_flushes) bleiben strukturell leer (Katalog T12 'Simulation, ehrlich gedeckelt').
