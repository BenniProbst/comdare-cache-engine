...
#include <organ_axes/io_dispatch/axis_io_flags.hpp>
...
public:
    ...
    COMDARE_DEFINE_ORGAN_LOCATION("::comdare::cache_engine::io_dispatch::DirectIo",
                                  "organ_axes/io_dispatch/axis_io_direct.hpp");
