...
// ─────────────────────────────────────────────────────────────────────────────
// V41.F.2: lookup = ECHTER physischer Namespace (organ_axes/lookup/), KEIN Alias (Forwarder).
// V41.F.2: cache_traversal = ECHTER physischer Namespace (organ_axes/cache_traversal/), KEIN Alias (Forwarder).
// V41.F.2: mapping = ECHTER physischer Namespace (organ_axes/mapping/), KEIN Alias (Forwarder).
// V41.F.2: path_compression = ECHTER physischer Namespace (organ_axes/path_compression/), KEIN Alias (Forwarder).
...
// V41.F.2: migration_policy ist jetzt der ECHTE physische Namespace (organ_axes/migration_policy/) -- KEIN Alias.
// Rueckwaerts-Alias migration::axis_migration→migration_policy liegt in den Forwardern (topics/migration/axis_migration/).
// V41.F.2: filter_axis = ECHTER physischer Namespace (organ_axes/filter_axis/), KEIN Alias (Forwarder).
