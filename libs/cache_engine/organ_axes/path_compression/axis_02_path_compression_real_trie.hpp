...
#include <organ_axes/alloc/axis_06_allocator_exgen.hpp> // A8-S5-02a: Versorger-Achse des Knoten-Pools (s.u.)
#include <cstddef>
#include <cstdint>
#include <string_view>
#include <type_traits>
...
/// Versorger-Achse; organ_axes/alloc/ zieht keinen path_compression-Header -> kein Zyklus.
