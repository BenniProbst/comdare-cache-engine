#pragma once
// §23-QUARANTAENE (2026-07-18): std::variant-basiert (je Achse ein variant) -> fuer statische/Organ-Achsen
// VERBOTEN (Runtime-Overhead + Code-Bloat, §23). NICHT in den Live-Codegen-Pfad verdrahten; der Live-Weg sind
// monomorphe CRTP+Concept-Achsen. Guard: tests/unit/test_striktheit_metaprog_guard.cpp (Block D).
// ---------------------------------------------------------------------------
