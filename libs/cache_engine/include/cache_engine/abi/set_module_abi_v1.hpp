...
#define COMDARE_DEFINE_SET_MODULE(...)                                               \
    using ComdareSetPermutationComposition =                                        \
        ::comdare::cache_engine::anatomy::SetComposition<__VA_ARGS__>;               \
    ...
    comdare_create_anatomy() noexcept {                                              \
        using AnatomyType =                                                          \
            ::comdare::cache_engine::anatomy::SetAnatomy<ComdareSetPermutationComposition>; \
        return new (::std::nothrow)                                                  \
            ::comdare::cache_engine::anatomy::SetAbiAdapter<AnatomyType>{};         \
    }                                                                                \
