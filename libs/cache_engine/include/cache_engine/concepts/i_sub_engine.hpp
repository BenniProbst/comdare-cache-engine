...
inline constexpr SubEngineSlot kPipelineOrder[12] = {
    SubEngineSlot::C05_Telemetry, SubEngineSlot::C10_Topologie, SubEngineSlot::C09_Heuristik,
    SubEngineSlot::C01_Layout,    SubEngineSlot::C08_Encoding,  SubEngineSlot::C06_Allocation,
    SubEngineSlot::C02_Pinning,   SubEngineSlot::C07_Migration, SubEngineSlot::C03_Prefetch,
    SubEngineSlot::C04_Coherence, SubEngineSlot::C12_Filter,    SubEngineSlot::C11_Scheduler};
...
public:
    ...
    virtual CacheRecommendation advise(const PlatformSnapshot& snap, const RequestContext& ctx,
