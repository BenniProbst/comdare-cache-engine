...
struct AllocatorPermutationFlags {
    ...
    [[nodiscard]] constexpr bool is_specified() const noexcept {
        return aa1 != FreeListTopology::Unspecified
            && aa2 != SizeClassSchema::Unspecified
            && aa3 != ThreadLocality::Unspecified
            && aa4 != Synchronization::Unspecified
            && aa5 != AllocationPolicy::Unspecified
            && aa6 != Reclamation::Unspecified
