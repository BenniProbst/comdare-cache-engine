...
static_assert(detail::framework_versionen_cpu_pflicht(),
              ...
              "Flags tragen (Owner-Q3 02.08.2026 / F-10 07.08.2026) -- COMDARE_VERSION_HW_FLAG_ENFORCE ist "
              "scharf. HINWEIS zur Historie: 'e' ist seit der Flag-Grammatik v2 EFFICIENCY CORE und damit "
              "legitim -- der frueher hier genannte Term \"NIE experimentell\" ist gegenstandslos");
#endif
