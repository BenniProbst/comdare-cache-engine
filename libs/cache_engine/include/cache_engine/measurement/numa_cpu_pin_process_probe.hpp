...
// startet dreistellig mit CPU-Flag als "1.0.0.c"; COMDARE_VERSION_HW_FLAG_ENFORCE ist SCHARF, ein
...
inline constexpr std::string_view kNumaCpuPinProcessProbeVersion = "1.0.0.c";
