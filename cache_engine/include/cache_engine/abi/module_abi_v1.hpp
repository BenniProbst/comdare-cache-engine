...
typedef struct comdare_cache_engine_v1 {
    ...
    void*         engine_state;
    comdare_cache_recommendation_v1 (*advise)(
        void* engine_state, comdare_request_context_v1 const* ctx);
    void          (*notify)(void* engine_state,
                            comdare_sub_engine_event_v1 const* event);
    void          (*snapshot)(void* engine_state,
                              comdare_platform_snapshot_v1* out);
...
typedef struct comdare_permutation_module_v1 {
    ...
    void          (*pull_live_counters)(void* instance,
                                        comdare_hw_counters_v1* out_counters);
