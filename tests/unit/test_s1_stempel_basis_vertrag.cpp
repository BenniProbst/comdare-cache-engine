...
//         (sha512_len-Doktrin, anatomy_module_abi_v1_decl.hpp:232-233); Planer-Gegenstueck == 64
//         (V-08R/KON101, je-Traeger-Bein). Seit F2-2 (KON8-03, #15-Nachlande) zusaetzlich:
//         System-Zeile GEFUELLT (Anzeige (1)), KEIN-AVX-Pin, ';ceb-system='-Segment im
//         Voll-Orakel, Zwillings-Guard gegen den Haus-Renderer.
...
// CEB-System-Fuellwert (KON8-03, seit F2-2/#15-Nachlande: gefuellt + KEIN-AVX-Pin +
// Zwillings-Guard), Baustein-Bindung (10), Dock-Nenner (5), g1-Ausgabeblock. NICHT GEPRUEFT
// (WARTE/eigene Posten, deklarierte Luecken): Tier-/Hybrid-ERBIN am Bestand (W-B/W-D -- die
