...
int main() {
    ...
    std::cout << "Unified-POD nach 20 insert + 20 lookup ueber die ABI:\n"
              << "  search_insert=" << u.axis_stats[0][3]
              << " search_lookup=" << u.axis_stats[0][0]
              << " | telemetry_total=" << u.axis_stats[10][0]
              << " telemetry_leaf=" << u.axis_stats[10][1]
              << " telemetry_node=" << u.axis_stats[10][2]
    ...
    std::cout << "  scan-Achsen ueber Slot-Backing: layout_records=" << u.axis_stats[5][1]
              << " layout_checksum=" << u.axis_stats[5][4]
              << " | serialization_records=" << u.axis_stats[9][1] << "\n";
    ...
    std::cout << "  node_type ueber Slot-Backing: find_count=" << u.axis_stats[4][0]
