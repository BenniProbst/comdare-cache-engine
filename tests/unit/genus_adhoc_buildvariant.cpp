...
COMDARE_DEFINE_ANATOMY_MODULE_ADHOC_BUILDVARIANT(
    ...
    // Bau-INC-2d: isa (axis_09 Amd64Isa) entfaellt — Target-ISA-System-Achse, kein Kompositions-Slot.
...
COMDARE_ANATOMY_VERSION_STAMP("system_fixture=perm_adhoc_buildvariant@1.0.0.c",
                              "fixture_kern=adhoc_buildvariant_avx512@1.0.0.c")
