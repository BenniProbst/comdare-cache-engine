...
int main() {
    ...
    for (auto const& v : lv[0].values) if (v == "node4") has_node4 = true;
    ...
    constexpr std::size_t expected = ex::enabled_count<AxNode> * ex::enabled_count<AxPath> * ex::enabled_count<AxLayout>;
