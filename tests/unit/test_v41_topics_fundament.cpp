...
TEST(PhaseF1_Concurrency, OlcOptimisticAxisBase) {
    static_assert(ce_topics::AxisBaseConcept<OlcOptimistic>);
    static_assert(ce_concepts::LegacyOriginalCodePflicht<OlcOptimistic>);
    static_assert(OlcOptimistic::concurrency_pattern() ==
...
TEST(PhaseF1_Prefetch, PrefetchNoneAxisBase) {
    static_assert(ce_topics::AxisBaseConcept<PrefetchNone>);
    static_assert(ce_concepts::LegacyOriginalCodePflicht<PrefetchNone>);
    static_assert(!PrefetchNone::is_active());
    SUCCEED();
}
