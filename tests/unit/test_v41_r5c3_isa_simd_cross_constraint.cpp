...
static_assert(hw::isa_platform_compatible<isa::Amd64Isa,   plat::X86_64HardwareProfile>(),  "x86_64-ISA auf x86_64-Plattform");
static_assert(hw::isa_platform_compatible<isa::Aarch64Isa, plat::Aarch64HardwareProfile>(), "aarch64-ISA auf aarch64-Plattform");
...
static_assert(!hw::isa_platform_compatible<isa::Amd64Isa,   plat::Aarch64HardwareProfile>(), "x86_64-ISA NICHT auf aarch64-Plattform");
static_assert(!hw::isa_platform_compatible<isa::Aarch64Isa, plat::X86_64HardwareProfile>(),  "aarch64-ISA NICHT auf x86_64-Plattform");
static_assert(!hw::isa_platform_compatible<isa::RiscVIsa,   plat::X86_64HardwareProfile>(),  "riscv64-ISA NICHT auf x86_64-Plattform");
static_assert(!hw::isa_platform_compatible<isa::PowerPcIsa, plat::Aarch64HardwareProfile>(), "ppc64le-ISA NICHT auf aarch64-Plattform");
...
static_assert(mp::mp_all_of<FullIsaPlatFiltered, IsCompatIsaPlat2>::value, "Voll-Filtered nur physisch moegliche Paare");
