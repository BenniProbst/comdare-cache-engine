...
using SetComp  = cea::SetComposition<TestKeySet, int, int, int, int, int, int, int, int, int, int, int, int>;
using SeqComp  = cea::SequenceComposition<int, int, int, int, int, int, int, int>; // Default DoublingGrowth
using ViewComp = cea::ViewComposition<int, int>;                                   // Default Layout/Accessor (INC-2c)
