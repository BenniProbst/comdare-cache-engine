...
#include <organ_axes/value_handle_axis/axis_14_value_handle_flags.hpp>
...
TEST(R7_5_d_ValueHandle, TopicConfigSetExposesAxis14) {
    ...
    static_assert(std::is_same_v<vh::TopicConfigSet::StaticAxisVariants, vh::TopicConfigSet::StaticAxisVariants_14>);
    SUCCEED();
}
