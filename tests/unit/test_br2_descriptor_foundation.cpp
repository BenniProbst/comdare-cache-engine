...
static_assert(ex::DynamicAxisNodeDescriptor<ConcurrencyDynTestDescriptor>, "ist dynamischer Deskriptor (mit variable())");
...
int main() {
    ...
    check_true("static: descriptor_kind == Static", AllocatorTestDescriptor::descriptor_kind() == ex::DescriptorKind::Static);
    ...
    check_true("dynamic: descriptor_kind == Dynamic", ConcurrencyDynTestDescriptor::descriptor_kind() == ex::DescriptorKind::Dynamic);
