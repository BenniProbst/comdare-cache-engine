...
// zurechenbar. Node-Organ-Variante: Node48NodeType (axis_04; vs Node256-Baseline). cl /LD /DCOMDARE_ANATOMY_MODULE_BUILD (CMake-Kontext, schwer).
...
COMDARE_DEFINE_ANATOMY_MODULE_ADHOC_BUILDVARIANT(
    ...
    ::comdare::cache_engine::nodes::axis_04_node_type::Node48NodeType,
