...
// zurechenbar. Variiertes Organ: VectorU8U8SearchAlgo (vs Array256-Baseline). cl /LD /DCOMDARE_ANATOMY_MODULE_BUILD (CMake-Kontext, schwer).
...
COMDARE_DEFINE_ANATOMY_MODULE_ADHOC_BUILDVARIANT(
    ...
    ::comdare::cache_engine::traversal::axis_03a_search_algo::VectorU8U8SearchAlgo,
