...
int main() {
    ...
    std::cout << "  Doubling=" << ev_double << " GoldenRatio=" << ev_golden
              << " FixedChunk<64>=" << ev_chunk << " Exact=" << ev_exact << "\n";
    tr("alle Policies feuern growth_events > 0 (real getrieben)", ev_double > 0 && ev_golden > 0 && ev_chunk > 0 && ev_exact > 0);
