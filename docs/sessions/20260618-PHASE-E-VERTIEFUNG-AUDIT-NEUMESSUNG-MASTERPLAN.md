...
| Task | Was | Status |
|------|-----|--------|
| **#158** | Audit-Restwelle **K10** — 11 Pattern-Integritäts-Befunde am Code terminalisieren (tote Memento-Rev.1 + CRUD-Commands entfernen; PMAJOR-04 Release-Kopplungen unter `#if COMDARE_MEASUREMENT_ON`; Factory/Observer-Etiketten ehrlich) | 🔄 Workflow `wxv51aawq` läuft |
