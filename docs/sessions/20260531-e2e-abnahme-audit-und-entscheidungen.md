...
### Nächster Schritt: P2 test-gedeckt ausführen (Mess-Raum über NAMED Organ-Compositions statt AdHoc-Default-Tupel), dann F15 neu + P3 (reale i7-1270P-Messung durch die geschlossene Pipeline).
