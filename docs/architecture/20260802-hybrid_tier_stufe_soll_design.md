...
> - **Magic `.A9.`** = `0x434F4D444141392EULL` -- Beleg `anatomy_module_abi_v1_decl.hpp:112`
>
...
| ABI-Magic (lebend seit 09.08.2026) | `anatomy_module_abi_v1_decl.hpp:112` | Magic `.A9.` = `0x434F4D444141392EULL` |
