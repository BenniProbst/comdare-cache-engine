...
> - **Major 9** -- Beleg `anatomy_module_abi_v1_decl.hpp:110` (NAHT-1, Mess-Naht am Genus-Interface)
...
| ABI-Major (lebend seit 09.08.2026) | `anatomy_module_abi_v1_decl.hpp:110` | Major 9 -- NAHT-1, Mess-Naht am Genus-Interface |
| ABI-Magic (lebend seit 09.08.2026) | `anatomy_module_abi_v1_decl.hpp:115` | Magic `.A9.` = `0x434F4D444141392EULL` |
