#pragma once
// CustomInterpreter — B^2-aehnlich, eigene Optimierungen fuer CustomAlignedStructure
...
class CustomInterpreter final : public ISearchPageStructureInterpreter {
public:
    ...
    [[nodiscard]] static CustomInterpreter const& instance() noexcept {
        static CustomInterpreter inst;
        return inst;
    }
};
